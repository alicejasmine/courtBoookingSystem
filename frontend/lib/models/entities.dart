...
class CourtBooking with _$CourtBooking {
  ...
  @freezed
  class CourtBookingWithCourtNumber with _$CourtBookingWithCourtNumber{
  const factory CourtBookingWithCourtNumber({
  required int bookingId,
  required int courtId,
  required int userId,
  required DateTime selectedDate,
  ...
  required DateTime creationTime,
  required int courtNumber
  }) = _CourtBookingWithCourtNumber;

  factory CourtBookingWithCourtNumber.fromJson(Map<String, dynamic> json) =>
  _$CourtBookingWithCourtNumberFromJson(json);
